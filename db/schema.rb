...
ActiveRecord::Schema.define(version: 2020_02_13_082622) do
  ...
  create_table "fishing_logs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.time "started_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.date "started_date"
  ...
  create_table "tides", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "cm"
    t.datetime "time"
